...
func (c *ConversionsOps) CelsiusToFahrenheit(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	celsius, ok := common.GetNumber(params, "celsius")
	if !ok {
		return common.Failure("celsius parameter required")
	}
	fahrenheit := (celsius * 9 / 5) + 32
	return common.Success(map[string]interface{}{"result": fahrenheit})
}
...
func (c *ConversionsOps) FahrenheitToCelsius(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	fahrenheit, ok := common.GetNumber(params, "fahrenheit")
	if !ok {
		return common.Failure("fahrenheit parameter required")
	}
	celsius := (fahrenheit - 32) * 5 / 9
	return common.Success(map[string]interface{}{"result": celsius})
}
...
func (c *ConversionsOps) MetersToFeet(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	meters, ok := common.GetNumber(params, "meters")
	if !ok {
		return common.Failure("meters parameter required")
	}
	feet := meters * 3.28084
	return common.Success(map[string]interface{}{"result": feet})
}
...
func (c *ConversionsOps) FeetToMeters(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	feet, ok := common.GetNumber(params, "feet")
	if !ok {
		return common.Failure("feet parameter required")
	}
	meters := feet / 3.28084
	return common.Success(map[string]interface{}{"result": meters})
}
...
func (c *ConversionsOps) MilesToKilometers(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	miles, ok := common.GetNumber(params, "miles")
	if !ok {
		return common.Failure("miles parameter required")
	}
	kilometers := miles * 1.60934
	return common.Success(map[string]interface{}{"result": kilometers})
}
...
func (c *ConversionsOps) KilometersToMiles(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	kilometers, ok := common.GetNumber(params, "kilometers")
	if !ok {
		return common.Failure("kilometers parameter required")
	}
	miles := kilometers / 1.60934
	return common.Success(map[string]interface{}{"result": miles})
}
...
func (c *ConversionsOps) CelsiusToKelvin(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	...
	return common.Success(map[string]interface{}{"result": kelvin})
}
...
func (c *ConversionsOps) KelvinToCelsius(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	kelvin, ok := common.GetNumber(params, "kelvin")
	if !ok {
		return common.Failure("kelvin parameter required")
	}
