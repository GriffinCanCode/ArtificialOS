...
func (c *ConstantsOps) Phi(ctx context.Context, params map[string]interface{}, appCtx *types.Context) (*types.Result, error) {
	...
	return Success(map[string]interface{}{"result": phi})
}
