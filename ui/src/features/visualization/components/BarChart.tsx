/**
 * Bar Chart Component
 * Renders dynamic bar charts with stacking support
 */
...
export const BarChart: React.FC<BaseComponentProps> = ({ component, state }) => {
  const props = component.props as BarChartProps;
  ...
  return (
    <div className="chart-container" style={{ width: width || "100%", height }}>
      <ResponsiveContainer width="100%" height="100%">
        <RechartsBar data={data} margin={margin} {...(animate && { isAnimationActive: true })}>
