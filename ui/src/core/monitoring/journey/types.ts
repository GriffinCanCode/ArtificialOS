...
// Types used within journeys for context enrichment
import type { LogContext } from '../core/logger';
import type { CausalEvent } from '../causality/tracker';

// These types are available for use but not directly referenced in this file
export type { LogContext, CausalEvent };
